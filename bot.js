...
(function() {
    ...
    */
    ...
    var vipIDs = [4080795, 27067405, 5039941, 631725, 5671563, 4103684, 20472203, 3742812, 3180606, 30107056, 0000000];
    var teste = [4080795];
    var rdjIDs = [, 5594653, 5639828, 34236782, 3905933, 3180606, 3878563, , , , 33614352, 32291773, 21759495, 33396914, 23381432, 1234, 33452321, 27848949, 32291773, 5826531, , 33147656, 33369539, 32505223, , 3802559, 31870874, 16922603, 31935034, 11541535, 5964136, 32380050, 5271323, 32716757, 32705996, 14120237, 3469337, 32585664, 23700131, 28172663, 3742812, 32127091, 27568399, 29974145, 3953469, , 31960171, 20920478, 15997523, 4673269, 29027247, 29260002, 5818382, 31691118, 17542742, 31520268, 19467293, 6500180, 31403444, 31388402, 4655712, 6125972, 28394366, 28664768, 3443587, 5859006, 29873102, 29872703, 11261222, 5695503, 5107283, 17250608, 5826531, 28688470, 5304943, 10943218, 27335647, 604204, 24902343, 3781336, 8167725, 24098438, 5782743, 24719836, 4288059,  3557353, 12601578, 5288871, 6202831, 3725627, 20472203, 4404834, 3466367, 4103684, , 23896297, 3810631, 5671563, 4656127, 631725, 5765109, 5579813, 5039941, 27067405, 13442483, 6511093, 3839549, 0000000]; 
    ...
    var basicBot = {
        ...
        cmdLink: 'http://moveitbrasil.ga/comandos-do-bot',
        ...
        settings: {
            ...
            welcome: true,
            opLink: 'http://moveitbrasil.ga/blacklist',
            rulesLink: 'http://moveitbrasil.ga/regras',
            ...
            blacklists: {
                NSFW: '#',
                OP: 'https://moveitbrasil.ga/blacklist-op-json/',
                BANNED: '#'
            }
        },
        room: {
        ...
        chatUtilities: {
            chatFilter: function(chat) {
                ...
                if (msg.indexOf('!loja') > -1) {
                 API.sendChat('Compre itens VIP Move It por boleto, acesse - http://moveitbrasil.ga/loja/');									
                 return true;
                }
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        var link = 'http://www.emoji-cheat-sheet.com/';
					                  	var link2 = 'http://moveitbrasil.ga/emotes.php';
...
msgCommand: {
    ...
    functionality: function (chat, cmd) {
        ...
        if (!basicBot.commands.executable(this.rank, chat)) return void (0);
            ...
            mensagens = [
                "!tema",
		"/me Tenha benefícios exclusivos com o VIP Move It, acesse http://moveitbrasil.ga/vip-move-it-conheca-os-beneficios/",
                "/me Veja como ter foto grande no seu chat http://moveitbrasil.ga/chat-e-foto-grande/ http://i.imgur.com/432N1pT.jpg",
                ...
                "/me Confira nossas regras em - http://moveitbrasil.ga/regras/",                		
	        		...
	        		fotoCommand: {
                             ...
                             functionality: function (chat, cmd) {
                                      ...
                                      if (!basicBot.commands.executable(this.rank, chat)) return void (0);
	                           		...
	                           		API.sendChat('/me Veja nesse link como ter sua foto no chat do Plug: http://moveitbrasil.ga/foto-no-chat-do-plug/');
                                         }
			                                }
                            },
            ...
            togglevoteskipCommand: {
             ...
             tretarCommand: {
                    ...
                    getTretar: function (chat) {
                     var c = Math.floor(Math.random() * basicBot.chat.tretas.length);
            ...
            botsonCommand: {
                 ...
                 functionality: function (chat, cmd) {
                  ...
                  if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    $.getScript("https://moveit-brasil.github.io/bot/simsimi.js");
                  }
                 }
                },
